...
import com.shixin.mapper.SysDictMapper;
import com.shixin.service.SysDictDataCommService;
import com.shixin.service.SysDictDataService;
import com.shixin.utils.PageUtil;
import com.shixin.entity.SysDictData;
import com.shixin.mapper.SysDictDataMapper;
...
//            List<SysDictData> dataList = baseMapper.selectList(sysDictDataQueryWrapper);
            List<SysDictData> dataList = selectDataByDictTypeCache(item.getType()); // 查询redis缓存
