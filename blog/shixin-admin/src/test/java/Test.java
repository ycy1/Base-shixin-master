...
import com.shixin.client.HttpApi;
 ...
 * @description TODO
 */
@SpringBootApplication(scanBasePackages = {"com.shixin.client"},
        exclude = {
...
@ComponentScan(
        basePackages = {"com.shixin.client"}
)
@RetrofitScan("com.shixin.client") // 扫描该包下的 @RetrofitClient 接口
