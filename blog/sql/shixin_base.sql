/*
 ...
 Source Schema         : shixin_base

 Target Server Type    : MySQL
 Target Server Version : 80040
 File Encoding         : 65001

 Date: 15/09/2026 21:27:07
*/
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '知识源配置表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_file_center`  (
  ...
  `expire_time` datetime(0) NULL DEFAULT NULL COMMENT '文件过期时间',
  `download_count` int(0) NULL DEFAULT 0 COMMENT '该文件被下载的次数',
  PRIMARY KEY (`id`) USING BTREE,
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '文件中心记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_order`  (
  ...
  INDEX `idx_create_time`(`create_time`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '订单主表' ROW_FORMAT = Dynamic;
